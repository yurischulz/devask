```tsx
<Question
  content="Mussum Ipsum, cacilds vidis litro abertis. Nullam volutpat risus nec leo commodo, ut interdum diam laoreet?"
  author={{
    name: "Yuri Schulz",
...
>
  ...
  <>
    <MarkdownEditor
      ...
      height={300}
    />
    <button className="button answer-button">Responder</button>
  </>
</Question>;
```
